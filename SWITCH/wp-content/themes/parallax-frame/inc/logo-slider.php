...
function parallax_frame_demo_logo_slider( $options ) {
	...
	<article id="featured-post-1" class="post hentry post-demo">
			<figure class="featured-content-image">
				<a href="#" rel="bookmark">
					<img alt="Demo Logo One" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/logo1.png" />
				</a>
			</figure>
	</article>
	...
	<article id="featured-post-2" class="post hentry post-demo">
		<figure class="featured-content-image">
			<a href="#" rel="bookmark">
				<img alt="Demo Logo Two" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/logo2.png" />
			</a>
		</figure>
	</article>
	...
	<article id="featured-post-3" class="post hentry post-demo">
		<figure class="featured-content-image">
			<a href="#" rel="bookmark">
				<img alt="Demo Logo Three" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/logo3.png" />
			</a>
		</figure>
	</article>
	...
	<article id="featured-post-4" class="post hentry post-demo">
		<figure class="featured-content-image">
			<a href="#" rel="bookmark">
				<img alt="Demo Logo Four" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/logo4.png" />
			</a>
		</figure>
	</article>
	...
	<article id="featured-post-5" class="post hentry post-demo">
		<figure class="featured-content-image">
			<a href="#" rel="bookmark">
				<img alt="Demo Logo Five" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/logo5.png" />
			</a>
		</figure>
	</article>';
}
...
function parallax_frame_post_page_category_logo_slider( $options ) {
	...
	while ( $get_hero_posts->have_posts() ) {
		...
		$output .= '
			...
			$image = '<img class="pngfix wp-post-image" src="'.get_template_directory_uri().'/images/gallery/no-featured-image-115x115.jpg" >';
