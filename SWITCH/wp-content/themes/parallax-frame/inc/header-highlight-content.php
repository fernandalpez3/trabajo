	...
	$parallax_frame_demo_content = '
		<article id="large-featured-image" class="post hentry post-demo">
			<figure class="header-highlight-content-image">
				<a rel="bookmark" href="#">
					<img alt="Photography" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/highlight1-1920x800.jpg" />
				</a>
			</figure>
		...
		<article id="header-highlight-post-1" class="post hentry post-demo">
			<figure class="header-highlight-content-image">
				<a rel="bookmark" href="#">
					<img alt="Female Rockstar" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured1-480x320.jpg" />
				</a>
			</figure>
			<div class="entry-container">
				<header class="entry-header">
		...
		<article id="header-highlight-post-2" class="post hentry post-demo">
			<figure class="header-highlight-content-image">
				<a rel="bookmark" href="#">
					<img alt="iPhoneography" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured2-480x320.jpg" />
				</a>
			</figure>
			<div class="entry-container">
				<header class="entry-header">
		...
		<article id="header-highlight-post-3" class="post hentry post-demo">
			<figure class="header-highlight-content-image">
				<a href="#">
					<img alt="Wildlife Photography" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured3-480x320.jpg" />
				</a>
			</figure>
			<div class="entry-container">
				<header class="entry-header">
		...
		<article id="header-highlight-post-4" class="post hentry post-demo">
			<figure class="header-highlight-content-image">
				<a href="#">
					<img alt="Dirt Bike Ride" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured4-480x320.jpg" />
				</a>
			</figure>
			<div class="entry-container">
				<header class="entry-header">
