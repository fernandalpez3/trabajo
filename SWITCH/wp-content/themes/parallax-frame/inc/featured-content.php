...
function parallax_frame_demo_content( $options ) {
	...
	<div class="featured_content_slider_wrap">
		<article id="featured-post-1" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured1-480x320.jpg" />
			</figure>
		...
		<article id="featured-post-2" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured2-480x320.jpg" />
			</figure>
			<div class="entry-container">
				<header class="entry-header">
					<h1 class="entry-title">
		...
		<article id="featured-post-3" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured3-480x320.jpg" />
			</figure>
			<div class="entry-container">
				<header class="entry-header">
					<h1 class="entry-title">
	...
	if ( 'layout-four' == $options['featured_content_layout']) {
		...
		<article id="featured-post-4" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured4-480x320.jpg" />
			</figure>
			<div class="entry-container">
				<header class="entry-header">
					<h1 class="entry-title">
	...
	if ( '1' == $options['featured_content_slider'] ) {
		...
		<div class="featured_content_slider_wrap">
			<article id="featured-post-5" class="post hentry post-demo">
				<figure class="featured-content-image">
					<img class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured5-480x320.jpg" />
				</figure>
				<div class="entry-container">
					<header class="entry-header">
						<h1 class="entry-title">
			...
			<article id="featured-post-6" class="post hentry post-demo">
				<figure class="featured-content-image">
					<img class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured6-480x320.jpg" />
				</figure>
				<div class="entry-container">
					<header class="entry-header">
						<h1 class="entry-title">
			...
			<article id="featured-post-7" class="post hentry post-demo">
				<figure class="featured-content-image">
					<img class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured7-480x320.jpg" />
				</figure>
				<div class="entry-container">
					<header class="entry-header">
						<h1 class="entry-title">
		...
		if ( 'layout-four' == $options['featured_content_layout']) {
			...
			<article id="featured-post-8" class="post hentry post-demo">
				<figure class="featured-content-image">
					<img class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured8-480x320.jpg" />
				</figure>
				<div class="entry-container">
					<header class="entry-header">
						<h1 class="entry-title">
...
function parallax_frame_post_page_category_content( $options ) {
	...
	while ( $loop->have_posts() ) {
		...
		$output .= '
			...
			$image = '<img class="pngfix wp-post-image" src="'.get_template_directory_uri().'/images/gallery/no-featured-image-1680x720.jpg" >';
