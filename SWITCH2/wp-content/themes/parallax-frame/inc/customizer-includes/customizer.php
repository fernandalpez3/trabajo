...
function parallax_frame_customize_preview() {
	wp_enqueue_script( 'parallax_frame_customizer', get_template_directory_uri() . '/js/customizer.min.js', array( 'customize-preview' ), '20120827', true );
...
function parallax_frame_customize_scripts() {
	wp_enqueue_script( 'parallax_frame_customizer_custom', get_template_directory_uri() . '/js/customizer-custom-scripts.min.js', array( 'customize-controls', 'iris', 'underscore', 'wp-util' ), '20150630', true );
