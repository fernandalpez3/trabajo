...
function parallax_frame_demo_portfolio( $options ) {
	...
	<article id="portfolio-post-1" class="post hentry post-demo">
		<figure class="portfolio-content-image featured-image">
			<a rel="bookmark" href="#">
				<img alt="White Velvet Concert" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/portfolio1-480x320.jpg" />
			</a>
		</figure>
	...
	<article id="portfolio-post-2" class="post hentry post-demo">
		<figure class="portfolio-content-image featured-image">
			<a rel="bookmark" href="#">
				<img alt="Female Rockstar" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/portfolio2-480x320.jpg" />
			</a>
		</figure>
		<div class="entry-container">
			<header class="entry-header">
	...
	<article id="portfolio-post-3" class="post hentry post-demo">
		<figure class="portfolio-content-image featured-image">
			<a href="#">
				<img alt="Great Vocalist" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/portfolio3-480x320.jpg" />
			</a>
		</figure>
		<div class="entry-container">
			<header class="entry-header">
	...
	<article id="portfolio-post-4" class="post hentry post-demo">
		<figure class="portfolio-content-image featured-image">
			<a href="#">
				<img alt="Best Rock Band" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/portfolio4-480x320.jpg" />
			</a>
		</figure>
		<div class="entry-container">
			<header class="entry-header">
	...
	<article id="portfolio-post-5" class="post hentry post-demo">
		<figure class="portfolio-content-image featured-image">
			<a rel="bookmark" href="#">
				<img alt="White Velvet Concert" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/portfolio5-480x320.jpg" />
			</a>
		</figure>
		<div class="entry-container">
			<header class="entry-header">
	...
	<article id="portfolio-post-6" class="post hentry post-demo">
		<figure class="portfolio-content-image featured-image">
			<a rel="bookmark" href="#">
				<img alt="Female Rockstar" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/portfolio6-480x320.jpg" />
			</a>
		</figure>
		<div class="entry-container">
			<header class="entry-header">
	...
	<article id="portfolio-post-7" class="post hentry post-demo">
		<figure class="portfolio-content-image featured-image">
			<a href="#">
				<img alt="Great Vocalist" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/portfolio7-480x320.jpg" />
			</a>
		</figure>
		<div class="entry-container">
			<header class="entry-header">
	...
	<article id="portfolio-post-8" class="post hentry post-demo">
		<figure class="portfolio-content-image featured-image">
			<a href="#">
				<img alt="Best Rock Band" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/portfolio8-480x320.jpg" />
			</a>
		</figure>
		<div class="entry-container">
			<header class="entry-header">
...
function parallax_frame_post_page_category_portfolio( $options ) {
	...
	while ( $loop->have_posts() ) {
		...
		$output .= '
			...
			$image = '<img class="wp-post-image" src="'.get_template_directory_uri().'/images/gallery/no-featured-image-1680x720.jpg" >';
